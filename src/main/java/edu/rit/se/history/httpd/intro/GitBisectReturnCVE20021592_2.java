...
/**
 * CVE-2002-1592: server/util_script.c
 * 
 ...
 * 
 * <pre>
 *  git bisect start f56bd9c539367865c061d7b077a07fff6c615c9c^ 5430f8800f5fffd57e7421dee0ac9de8ca4f9573 -- server/util_script.c
 ...
 * 
 */
public class GitBisectReturnCVE20021592_2 {
	...
	private static final String FILE = "server/util_script.c";
	...
	public static boolean isVulnerable(String fileName) throws IOException {
		...
		if (has(stringBuffer, "" + //
				...
				"ap_log_rerror(APLOG_MARK, APLOG_NOERRNO|APLOG_ERR, 0, r," + // this line was wrong
				"\"Premature end of script headers: %s\", r->filename);" + //
				"return HTTP_INTERNAL_SERVER_ERROR;" + //
				"" //
		) && (has(stringBuffer, "" + //
				"ap_log_rerror(APLOG_MARK, APLOG_NOERRNO|APLOG_ERR, 0, r," + //
				"\"%s: %s\", malformed, r->filename);" + // this line was wrong
				"return HTTP_INTERNAL_SERVER_ERROR;" + //
				"" //
		))) {
			isVulnerable = true;
