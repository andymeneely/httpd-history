 ...
 * 
 */
public class GitBisectReturnCVE20065752 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bisecting for <CVE-2006-5752>");
		try {
	...
	public static boolean bisectBadOrGood(String fileName) throws FileNotFoundException {
		...
		try {
			 ...
			 */
			if (stringBuffer.indexOf("ap_set_content_type(r, \"text/html; charset=ISO-8859-1\");") > 0
					&& stringBuffer.indexOf("ap_set_content_type(r, \"text/plain; charset=ISO-8859-1\");") > 0
					&& stringBuffer.indexOf("ap_escape_logitem(r->pool,") > 0) {
				System.out.println("Good Commit Context Met, commit was good");
				goodCommit = true;
			} else if (stringBuffer.indexOf("ap_set_content_type(r, \"text/html\");") > 0
					&& stringBuffer.indexOf("ap_set_content_type(r, \"text/plain\");") > 0
					&& stringBuffer.indexOf("ws_record->request),") > 0
					&& stringBuffer.indexOf("ws_record->request));") > 0) {
