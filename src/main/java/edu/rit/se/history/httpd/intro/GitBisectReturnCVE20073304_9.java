...
/**
 * CVE-2007-3304: /server/mpm/mpmt_os2/mpm.h
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20073304_9 {
	...
	public static boolean bisectBadOrGood(String fileName) throws FileNotFoundException {
		...
		try {
			 ...
			 */
			if (stringBuffer.indexOf("<placeholder>") > 0) {
				System.out.println("Good Commit Context Met, commit was good");
				goodCommit = true;
			} else if (stringBuffer.indexOf("<placeholder>") < 0) {
