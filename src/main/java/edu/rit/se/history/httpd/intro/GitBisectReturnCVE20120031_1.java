 ...
 * _1 denotes bisect script for the file: ap_mmn.h
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20120031_1 {
	...
	public static boolean bisectBadOrGood(String fileName)
		...
		try {
			 ...
			 */
			if(stringBuffer.indexOf("* 20120111.0 (2.5.0-dev)  Remove sb_type from global_score.")>0 
					&&stringBuffer.indexOf("#define MODULE_MAGIC_NUMBER_MAJOR 20120111")>0
					) {
				System.out.println("Good Commit Context Met, commit was good");
				goodCommit = true;
			} else if(stringBuffer.indexOf("* 20120111.0 (2.5.0-dev)  Remove sb_type from global_score.")<0 
					&&stringBuffer.indexOf("#define MODULE_MAGIC_NUMBER_MAJOR 20120109")>0
					) {
