...
public class GitBisectReturnCVE20101623 {
	...
	public static boolean bisectBadOrGood(String fileName) throws FileNotFoundException {
		...
		try {
			 ...
			 */
			if (stringBuffer
					.indexOf("static apr_status_t brigade_append(apr_bucket_brigade *bbOut, apr_bucket_brigade *bbIn)") > 0
			 ...
			 * "static apr_status_t brigade_append(apr_bucket_brigade *bbOut, apr_bucket_brigade *bbIn)")<0
			 * &&stringBuffer.indexOf("rv = brigade_append(ccfg->tmpbb, bb);")<0
			 */
			) {
