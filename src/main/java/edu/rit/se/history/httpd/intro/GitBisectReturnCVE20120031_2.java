...
/**
 * CVE-2012-0031 First instance where we see that a fix involved multiple files. _2 denotes bisect script for
 * the file: scoreboard.h
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20120031_2 {
	...
	public static boolean bisectBadOrGood(String fileName) throws FileNotFoundException {
		...
		try {
			 ...
			 */
			if (stringBuffer.indexOf("ap_scoreboard_e sb_type;") < 0) {
				System.out.println("Good Commit Context Met, commit was good");
				goodCommit = true;
			} else if (stringBuffer.indexOf("ap_scoreboard_e sb_type;") > 0) {
