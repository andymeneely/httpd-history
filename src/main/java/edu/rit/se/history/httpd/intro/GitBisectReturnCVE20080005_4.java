...
/**
 * CVE-2008-0005: /modules/proxy/mod_proxy_balancer.c
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20080005_4 {
	...
	public static boolean bisectBadOrGood(String fileName)
		...
		try {
			 ...
			 */
			if(stringBuffer.indexOf("static int balancer_handler(request_rec *r)")>0
				...
				goodCommit = true;
			} else if(stringBuffer.indexOf("static int balancer_handler(request_rec *r)")>0
