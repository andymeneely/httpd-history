...
/**
 * CVE-2008-0005: /modules/proxy/mod_proxy_ftp.c
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20080005_5 {
	...
	public static boolean bisectBadOrGood(String fileName) throws FileNotFoundException {
		...
		try {
			 ...
			 */
			if (stringBuffer.indexOf("static int proxy_ftp_handler(request_rec *r, proxy_worker *worker,") > 0
				...
				goodCommit = true;
			} else if (stringBuffer.indexOf("static int proxy_ftp_handler(request_rec *r, proxy_worker *worker,") > 0
