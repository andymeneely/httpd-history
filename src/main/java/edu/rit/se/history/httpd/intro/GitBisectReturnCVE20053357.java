...
/**
 * CVE-2005-3357: /modules/ssl/ssl_engine_kernel.c
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20053357 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bisecting for <CVE-2005-3357>");
		try {
	...
	public static boolean bisectBadOrGood(String fileName)
		...
		try {
			...
			if(stringBuffer.indexOf("int ssl_hook_Access(request_rec *r)")>0
					&&stringBuffer.indexOf("if (sc->enabled == SSL_ENABLED_FALSE || !ssl) {")>0
					) {
				...
				goodCommit = true;
					...
					&&stringBuffer.indexOf(" if (!((sc->enabled == SSL_ENABLED_TRUE) || (sc->enabled == SSL_ENABLED_OPTIONAL) || ")>0
					) {
