...
/**
 * CVE-2004-0748: /modules/ssl/ssl_engine_io.c
 * @author harsha
 * @version v2
 * 
 */
public class GitBisectReturnCVE20040748 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bisecting for <CVE-2004-0748>");
		try {
	...
	public static boolean bisectBadOrGood(String fileName)
		...
		try {
			...
			if(stringBuffer.indexOf("static apr_status_t ssl_io_input_read(bio_filter_in_ctx_t *inctx,")>0
					&&stringBuffer.indexOf("if (!inctx->filter_ctx->pssl) {")>0
					&&stringBuffer.indexOf("/* Ensure a non-zero error code is returned */")>0
					) {
