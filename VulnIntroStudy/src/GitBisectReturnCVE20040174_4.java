...
/**
 * CVE-2004-0174: /server/listen.c
 * avoiding configure.in as the fix was a completely new feature, independent of the
 * existing code and hence vulnerable since first commit
 * @author harsha
 * @version v2
 * 
 */
